    ...
    <div class="post_header">
        <div class="post_header_h3">
            ...
            <div class="prathyusha" >
                <asp:Label ID="street" runat="server" Text="Street" Font-Size="Medium"></asp:Label><br />
                <asp:Label ID="city" runat="server" Text="City" Font-Size="Medium"></asp:Label><br />
                <asp:Label ID="zipcode" runat="server" Text="Zipcode" Font-Size="Medium"></asp:Label><br /> <br /><br />
                 <asp:Label ID="contact" runat="server" Text="Contact"  Font-Size="Medium" float="left"></asp:Label>
                <br />
                <asp:Label ID="service1" runat="server" Text="Service"  float="left" Font-Size="Medium"></asp:Label><br />
                <asp:Label ID="timings" runat="server" Text="OfficeTimings" float="left" Font-Size="Medium"></asp:Label>
                <br />
               <br />
